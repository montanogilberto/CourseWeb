...
class LevelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create level" do
    assert_difference('Level.count') do
      post levels_url, params: { level: { complete: @level.complete, name: @level.name, percent: @level.percent } }
    end
  ...
  test "should update level" do
    patch level_url(@level), params: { level: { complete: @level.complete, name: @level.name, percent: @level.percent } }
